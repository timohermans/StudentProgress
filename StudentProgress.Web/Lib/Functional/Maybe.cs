namespace StudentProgress.Web.Lib.Functional;
...
public static class MaybeExtensions
{
    ...
    public static async Task<TToType> MapAsync<TFromType, TToType>(this Maybe<TFromType> @this,
