...
[Collection("canvas")]
public class GetAllTests : CanvasTests
{
    public GetAllTests(CanvasFixture fixture) : base(fixture)
    {
    }
    ...
    public async Task Gets_all_courses()
    {
        ...
        sem1.Term.StartAt.Value.AsUtc().Should().Be(new DateTime(2022, 8, 1));
        sem1.Term.EndAt.Value.AsUtc().Should().Be(new DateTime(2023, 3, 27));
